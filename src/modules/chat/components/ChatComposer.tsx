  ...
  return (
    <form onSubmit={handleSubmit} className="border-t border-slate-800 bg-slate-950/90 p-4">
      <div className="flex items-center gap-1 rounded-xl border border-slate-700 bg-slate-900 px-2 py-2">
        <button type="button" className="rounded-md p-2 text-slate-400 hover:bg-slate-800 hover:text-slate-200" aria-label="Lampiran">
          <Paperclip size={16} />
        </button>
        <button type="button" className="rounded-md p-2 text-slate-400 hover:bg-slate-800 hover:text-slate-200" aria-label="Browser">
          <Globe size={16} />
        </button>
        <button type="button" className="rounded-md p-2 text-slate-400 hover:bg-slate-800 hover:text-slate-200" aria-label="Voice">
          <Mic size={16} />
        </button>
        <input
          {...register('message')}
