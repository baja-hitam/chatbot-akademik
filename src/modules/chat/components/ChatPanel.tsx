...
export function ChatPanel({
  ...
  return (
    <section className="flex min-w-0 flex-1 flex-col h-full bg-slate-950">
      <header className="flex h-16 shrink-0 items-center justify-between border-b border-slate-800 bg-slate-950/70 px-4 py-3 backdrop-blur">
      ...
      <div
        ref={containerRef}
        className="flex-1 space-y-4 overflow-y-auto no-scrollbar bg-slate-950/20 px-4 py-5 sm:px-6 scroll-smooth"
      >
        {isLoadingMessages ? (
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-3 animate-pulse">
              ...
              <div className="max-w-[85%] rounded-2xl bg-slate-900/60 border border-slate-800 px-4 py-3 space-y-2 flex-1">
                <div className="h-4 w-48 rounded bg-slate-800"></div>
                <div className="h-3 w-full max-w-[28rem] rounded bg-slate-800/80"></div>
                <div className="h-3 w-full max-w-[20rem] rounded bg-slate-800/80"></div>
              </div>
            </div>
            {/* User message skeleton */}
            <div className="flex justify-end animate-pulse">
        ...
        {isSending && (
          <div className="flex items-start gap-3">
            ...
            <div className="max-w-[85%] rounded-2xl bg-slate-800 px-4 py-3 text-sm text-slate-300 shadow-sm">
