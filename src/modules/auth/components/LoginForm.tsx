...
export function LoginForm() {
  ...
  return (
    <main className="relative flex min-h-dvh items-center justify-center bg-slate-50 dark:bg-slate-950 px-4 py-8 text-slate-900 dark:text-slate-100">
        ...
        <div className="p-6 sm:p-10">
          <div className="mx-auto w-full max-w-md">
            <div className="mb-8 lg:hidden">
              ...
              <h1 className="mt-4 text-2xl font-semibold text-slate-900 dark:text-white">Masuk ke dashboard</h1>
            </div>

            <form onSubmit={handleSubmit(submitForm)} className="space-y-4">
              {
                loginMutation.error instanceof Error && (
                  <div className="rounded-md border border-rose-200 bg-rose-50 text-rose-600 dark:border-rose-800/50 dark:bg-rose-950/50 p-3 text-sm dark:text-rose-300">
              ...
              <label className="block space-y-2">
                ...
                <span className="flex items-center rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-950 px-3 focus-within:border-indigo-400">
                  <Mail size={16} className="text-slate-400 dark:text-slate-500" />
                  <input
                    type="email"
                    className="w-full bg-transparent px-3 py-3 text-sm outline-none placeholder:text-slate-400 dark:placeholder:text-slate-500"
