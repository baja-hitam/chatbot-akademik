  ...
  return (
    <div className="p-4 md:p-8 flex flex-col h-[calc(100dvh-73px)] lg:h-dvh">
      <div className="mb-6 flex items-center gap-4 shrink-0">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Detail Percakapan</h1>
          <p className="mt-1 text-sm text-slate-600 dark:text-slate-400">ID Sesi: {sessionId}</p>
        </div>
      </div>

      <div className="flex-1 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900 p-4 md:p-6 flex flex-col min-h-0 overflow-hidden">
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-1 overflow-hidden">
                      ...
                      <span className={`text-[10px] mt-1 ${isBot ? 'text-slate-600 dark:text-slate-400' : 'text-indigo-200'}`}>
