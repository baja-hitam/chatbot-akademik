  ...
  return (
    ...
    >
      ...
      <nav className="flex-1 space-y-2">
        <Link
          to="/admin"
          className="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition-colors text-slate-600 hover:bg-slate-100 hover:text-slate-900 dark:text-slate-400 dark:hover:bg-slate-800 dark:hover:text-white"
      ...
      <div className="mt-auto pt-4 border-t border-slate-200 dark:border-slate-800">
        ...
        <div className="mb-4 flex items-center gap-3 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950/70 p-3">
          <UserCircle2 size={24} className="text-indigo-300" />
          <div className="min-w-0">
            <p className="truncate text-sm text-slate-900 dark:text-slate-200">{user?.full_name ?? 'Admin'}</p>
